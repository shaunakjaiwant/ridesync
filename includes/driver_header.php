...
<nav class="driver-navbar">
    ...
    <ul class="driver-nav-links">
        <li><a class="<?php echo $currentDriverPage === 'driver_dashboard.php' ? 'is-active' : ''; ?>" href="/ridesync/pages/driver_dashboard.php">Dashboard</a></li>
        <li><a class="<?php echo $currentDriverPage === 'driver_requests.php' ? 'is-active' : ''; ?>" href="/ridesync/pages/driver_requests.php">Queue</a></li>
        <li><a class="<?php echo $currentDriverPage === 'driver_earnings.php' ? 'is-active' : ''; ?>" href="/ridesync/pages/driver_earnings.php">Earnings</a></li>
