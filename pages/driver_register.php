...
<div class="form-container auth-register-form">
    ...
    <form action="/ridesync/actions/driver_auth_action.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" required placeholder="Driver name">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="license_number" name="license_number" required maxlength="80" placeholder="Driving license number">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="vehicle_number" name="vehicle_number" required maxlength="40" placeholder="KA 19 AB 1234">
        </div>
        ...
        <div class="form-group">
            ...
            <select id="seating_capacity" name="seating_capacity" required>
                <?php for ($i = 1; $i <= 8; $i++): ?>
                    <option value="<?php echo $i; ?>" <?php echo $i === 4 ? 'selected' : ''; ?>><?php echo $i; ?> seat<?php echo $i === 1 ? '' : 's'; ?></option>
                <?php endfor; ?>
            </select>
        </div>
        ...
        <div class="form-group form-group-wide">
            ...
            <input type="text" id="document_reference" name="document_reference" maxlength="255" placeholder="File name, document ID, or note">
        ...
        <div class="form-group form-group-wide">
            ...
            <input type="text" id="aadhaar_reference" name="aadhaar_reference" maxlength="255" placeholder="Masked Aadhaar note or uploaded file reference">
        ...
        <div class="form-group form-group-wide">
            ...
            <input type="text" id="pan_reference" name="pan_reference" maxlength="255" placeholder="PAN note or uploaded file reference">
        ...
        <div class="form-group form-group-wide">
            ...
            <input type="text" id="id_proof_reference" name="id_proof_reference" maxlength="255" placeholder="Student/local ID, Aadhaar note, or uploaded file reference">
        ...
        <div class="form-group form-group-wide">
            ...
            <input type="text" id="vehicle_rc_reference" name="vehicle_rc_reference" maxlength="255" placeholder="RC document ID, file name, or note">
        ...
        <div class="form-group form-group-wide">
            ...
            <input type="text" id="insurance_reference" name="insurance_reference" maxlength="255" placeholder="Insurance policy/file reference">
        ...
        <div class="form-group form-group-wide">
            ...
            <input type="text" id="selfie_reference" name="selfie_reference" maxlength="255" placeholder="Selfie file reference or note">
        ...
        <div class="form-group form-group-wide">
            ...
            <input type="text" id="vehicle_image_reference" name="vehicle_image_reference" maxlength="255" placeholder="Vehicle image file reference or note">
        ...
        <div class="form-group form-group-wide">
            ...
            <input type="text" id="other_document_reference" name="other_document_reference" maxlength="255" placeholder="Any extra verification file or note">
        ...
        <div class="form-group form-group-wide">
            ...
            <textarea id="verification_details" name="verification_details" placeholder="Add any detail needed for verification."></textarea>
        </div>
